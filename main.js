...
//
// لا يتم الاعتماد على امتداد الرابط.
// أي URL يتم إرساله إلى FFprobe.
// ======================================================
...
//
// هذه فقط لمعرفة هل يجب تكرار الملف.
// أما باقي الروابط فلا يتم رفضها.
// ======================================================
...
//
// مهم:
// لا يتم رفض أي نوع رابط.
//
// FFmpeg يستقبل الرابط مباشرة.
// إذا كان FFmpeg يدعم المصدر فسيعمل.
//
// أمثلة:
// MP4
// M3U8
...
function buildFFmpegArgs(
    ...
    args.push(
        ...
        // إعادة اتصال للمصادر التي تدعمها
        "-reconnect",
        "1",
...
async function startStream(
    ...
    process.on(
        ...
        async code => {
            ...
            // لا ترسل رسالة إذا كان الإيقاف يدويًا
            if (manualStop) {
                return;
            }
